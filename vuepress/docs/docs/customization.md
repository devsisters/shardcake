...
```scala
libraryDependencies += "com.devsisters" %% "shardcake-storage-redis" % "2.6.0"
```
...
```scala
libraryDependencies += "com.devsisters" %% "shardcake-serialization-kryo" % "2.6.0"
```
...
```scala
libraryDependencies += "com.devsisters" %% "shardcake-health-k8s" % "2.6.0"
```
