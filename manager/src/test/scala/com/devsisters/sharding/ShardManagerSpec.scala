...
import com.devsisters.sharding.ShardManager.{ PodWithMetadata, ShardManagerState }
import com.devsisters.sharding.interfaces.{ Pods, PodsHealth, Storage }
import zio._
...
object ShardManagerSpec extends ZIOSpecDefault {
  ...
  val config: ULayer[Config] = ZLayer.succeed(Config(300, 0))
